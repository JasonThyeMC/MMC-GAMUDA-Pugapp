 ...
 * {@link webFrag.OnFragmentInteractionListener} interface
...
public class webFrag extends Fragment {
    ...
    public void onViewCreated(View v, Bundle savedInstanceState){
        ...
        String html = null;
        try {
            InputStream is = getActivity().getAssets().open("graph.html");
            ...
            is.close();
            html = code;
            Log.i("Over here", html);

        } catch (IOException e) {
            e.printStackTrace();
        }

        webView.loadDataWithBaseURL("file:///android_asset", html, "text/html", "utf-8", "about:blank");
    }
